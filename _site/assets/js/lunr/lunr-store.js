var store = [{
        ...
        "excerpt":"Switching On a local/remote PC via terminal Setup I have a local PC having GPU which I use to run Machine Learning model and and some heavy, It only has a LAN port and is kept near to the router which is not next to my working desk. I mostly...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/2021/01/23/switching_on_computer_remotely.html",
        "teaser": null
      }]
